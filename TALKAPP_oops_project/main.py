...
class main_loop(object):
    ...
    def __init__(self, username):
        ...
        self.win_label = Label(self.win, text='', bg=self.bg, height=12, width=450, font=('arial black', 15, 'bold'),
                               relief='groove')
        self.title_label = Label(self.win, text='TALKAPP', bg=self.bg, fg='dark blue',
    ...
    def about_func(self):
        ...
        mb.showinfo('About',
                    '\nThis is an exclusive distribution of TALKAPP created By object Oriented Programming Team 2. \n'
