...
class Login:
    ...
    def login_screen(self):
        ...
        # Creating labels
        self.canvas1.create_text(200, 40, text="TALKAPP", font=('Comic Sans MS', 40, 'bold'), fill='dark blue',
                            activefill='blue')
...
class Register:
    ...
    def register_screen(self):
        ...
        # Creating labels
        self.canvas2.create_text(200, 40, text="TALKAPP", font=('Comic Sans MS', 40, 'bold'), fill='dark blue',
                            activefill='blue')
